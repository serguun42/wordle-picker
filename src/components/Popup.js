 ...
 * @property {(string | Element | JSX.Element)[]} [messages] Layout ready lines
    ...
    <div className="popup-container" ref={popupRef}>
      ...
      <div className="popup-body">
        ...
        <div className="popup__actions">
          ...
          {typeof popupState.acceptAction === 'function' ? (
            <div
              className="popup__action default-pointer default-no-select"
              onClick={() => {
