...
export default function Footer() {
  const footerLinks = [
    { icon: 'home', href: '/', text: 'Home', router: true },
    ...
    <footer className="footer">
      <section className="footer__section footer__section--logo">
        ...
        <div className="footer__logo-desc">
          <div className="footer__logo-desc__title default-title-font">Wordle Picker</div>
          <div>
      ...
      <section className="footer__section">
        <div className="footer__section__item">
          ...
          <a href="https://github.com/serguun42/wordle-picker" target="_blank" rel="noopener noreferrer">
            Github
          </a>
        </div>
